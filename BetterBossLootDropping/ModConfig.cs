...
internal class ModConfig
{
    ...
    public static ConfigEntry<bool> DisableLII;
    ...
    public static void InitConfig(ConfigFile config)
    {
        ...
        DisableLII = config.Bind("Loot into inventory", "Loot into inventory", defaultValue: true, "Should boss items go straight into inventory");
